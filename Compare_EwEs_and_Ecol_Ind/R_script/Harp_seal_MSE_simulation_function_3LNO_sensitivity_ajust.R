...
Harp_seal_MSE_simulation_function_3LNO_sensitivity_ajust <- function(prop_sensitivity, region, data_simulation, title){
  ...
  data_process <- data_simulation %>%
    ...
    mutate(
      ...
      Harp_seal_total_biomass_3LNO = biomass_seal * 257400
    ) %>%
    mutate(Year = 2035) %>%
    mutate(
  ...
  gg <- ggplot(data_assessment, aes(x = Year, y = Biomass_T_area_rescale)) +
    ...
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 1.10), color = "#2ca02c", size = 0.05, show.legend = FALSE) +
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 0.924), color = "#d62728", size = 0.05, show.legend = FALSE) +
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 1.28), color = "#ff7f0e", size = 0.05, show.legend = FALSE) +
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 1.24), color = "#1f77b4", size = 0.05, show.legend = FALSE) +
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 2.11), color = "#9467bd", size = 0.05, show.legend = FALSE) +
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 2.72), color = "#e377c2", size = 0.05, show.legend = FALSE) 
