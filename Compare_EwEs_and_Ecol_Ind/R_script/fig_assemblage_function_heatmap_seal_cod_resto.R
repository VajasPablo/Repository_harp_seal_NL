...
fig_assemblage_function_heatmap_seal_cod_resto <- function() {
  ...
  heat_2013_cod <- heatmap_multispecific_biomass_restoration_function(data = Df_merged_seal_vs_cod_biomass_final_EwE_2013,
