...
gg <- ggplot(data_assessment, aes(x = Year, y = Biomass_T_area_rescale)) +
  ...
  geom_hline(yintercept = 66528.00, linetype = "dashed", color = "black") +
  ...
  geom_point(x = c(2020), y = c(66528), color = "gray30",size = 2)  +
 # annotate("text", x = c(1985, 2013), y = c(52866, 65835), label = "EwE \nvalue", vjust = -0.5, size = 3, color = "black") +
  geom_segment(aes(x = 2020, y = 66528.00, xend = 2035, yend = 67199), color = "blue", size = 0.05, show.legend = FALSE) +
  geom_segment(aes(x = 2020, y = 66528.00, xend = 2035, yend = 59858), color = "green", size = 0.05, show.legend = FALSE) +
  geom_segment(aes(x = 2020, y = 66528.00, xend = 2035, yend = 56967), color = "red", size = 0.05, show.legend = FALSE) +
  geom_segment(aes(x = 2020, y = 66528.00, xend = 2035, yend = 64249), color = "orange", size = 0.05, show.legend = FALSE) +
  geom_segment(aes(x = 2020, y = 66528.00, xend = 2035, yend = 80737), color = "blue", size = 0.05, show.legend = FALSE) +
  geom_segment(aes(x = 2020, y = 66528.00, xend = 2035, yend = 98444), color = "purple", size = 0.05, show.legend = FALSE) +
  geom_segment(aes(x = 2020, y = 66528.00, xend = 2035, yend = 119860), color = "pink", size = 0.05, show.legend = FALSE) +
  theme_bw() +
  ...
  theme(axis.title.x = element_text(size = 14),
        ...
        legend.text = element_text(size = 10)) + ylab("Rescale Harp seal Biomass")
