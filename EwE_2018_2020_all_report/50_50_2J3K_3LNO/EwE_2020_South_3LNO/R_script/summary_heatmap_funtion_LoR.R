...
summary_heatmap_funtion_LoR <- function(data_sp_cod, sp_cod_1, sp_cod_2, nb_row_spcod_1, nb_row_spcod_2,
  ...
  new_row_2_1 <- c(Group_name = sp_cod_1, LoR_1 = 0, LoR_10 = 0, LoR_obs =0, LoR_20 = 0, LoR_30 = 0, LoR_40 = 0,
                   LoR_50 = 0, LoR_60 = 0, LoR_70 = 0, LoR_80 = 0, LoR_90 = 0, LoR_100 = 0)
  new_row_2_2 <- c(Group_name = sp_cod_2, LoR_1 = 0, LoR_10 = 0, LoR_obs =0, LoR_20 = 0, LoR_30 = 0, LoR_40 = 0,
                   LoR_50 = 0, LoR_60 = 0, LoR_70 = 0, LoR_80 = 0, LoR_90 = 0, LoR_100 = 0)
  ...
  pivot_data_cod <- pivot_data_cod %>%
    mutate(LoR = factor(LoR, levels = c("LoR 1", "LoR 10", "LoR obs", "LoR 20", "LoR 30", "LoR 40", "LoR 50", "LoR 60", "LoR 70", "LoR 80", "LoR 90", "LoR 100")))
