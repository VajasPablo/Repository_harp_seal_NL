...
gg <- ggplot(data_assessment, aes(x = Year, y = Biomass_T_area_rescale)) +
  ...
  geom_hline(yintercept = 26872.56, linetype = "dashed", color = "black") +
 ...
 # annotate("text", x = c(1985, 2013), y = c(52866, 65835), label = "EwE \nvalue", vjust = -0.5, size = 3, color = "black") +
  geom_segment(aes(x = 2020, y = 26872.56, xend = 2035, yend = 26864), color = "blue", size = 0.05, show.legend = FALSE) +
  geom_segment(aes(x = 2020, y = 26872.56, xend = 2035, yend = 29585), color = "green", size = 0.05, show.legend = FALSE) +
  geom_segment(aes(x = 2020, y = 26872.56, xend = 2035, yend = 24840), color = "red", size = 0.05, show.legend = FALSE) +
  geom_segment(aes(x = 2020, y = 26872.56, xend = 2035, yend = 26829), color = "blue", size = 0.05, show.legend = FALSE) +
  geom_segment(aes(x = 2020, y = 26872.56, xend = 2035, yend = 42251), color = "orange", size = 0.05, show.legend = FALSE) +
  geom_segment(aes(x = 2020, y = 26872.56, xend = 2035, yend = 56685), color = "purple", size = 0.05, show.legend = FALSE) +
  geom_segment(aes(x = 2020, y = 26872.56, xend = 2035, yend = 73135), color = "pink", size = 0.05, show.legend = FALSE) +
  scale_y_continuous(
    limits = c(0, 300000),                   
