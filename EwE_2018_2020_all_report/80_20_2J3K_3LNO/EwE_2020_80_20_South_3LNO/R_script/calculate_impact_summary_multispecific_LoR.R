...
calculate_impact_summary_multispecific_LoR <- function(F_data, species_unselect, species_1, species_2, total_number_group, species_short) {
  ...
  df_group_impacted <- function(F_data, species_unselect){
    ...
    # Create LoR_obs
    col_name <- paste0("LoR_", species_1, "_obs_LoR_", species_2, "_obs")
