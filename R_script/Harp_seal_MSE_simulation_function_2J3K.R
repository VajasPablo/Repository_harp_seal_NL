...
Harp_seal_MSE_simulation_function_2J3K <- function(prop_sensitivity, region, data_simulation, title){
  ...
  gg <- ggplot(data_assessment, aes(x = Year, y = Biomass_T_area_rescale)) +
    ...
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 1.01), color = "blue", size = 0.05, show.legend = FALSE) +
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 0.900), color = "green", size = 0.05, show.legend = FALSE) +
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 0.856), color = "red", size = 0.05, show.legend = FALSE) +
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 0.966), color = "orange", size = 0.05, show.legend = FALSE) +
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 1.21), color = "blue", size = 0.05, show.legend = FALSE) +
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 1.48), color = "purple", size = 0.05, show.legend = FALSE) +
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 1.80), color = "pink", size = 0.05, show.legend = FALSE)
