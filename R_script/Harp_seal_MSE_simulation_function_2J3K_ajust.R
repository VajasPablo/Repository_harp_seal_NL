...
Harp_seal_MSE_simulation_function_2J3K_ajust <- function(prop_sensitivity, region, data_simulation, title){
  ...
  gg <- ggplot(data_assessment, aes(x = Year, y = Biomass_T_area_rescale)) +
    ...
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 1.01), color = "#1f77b4", size = 0.05, show.legend = FALSE) +
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 0.900), color = "#2ca02c", size = 0.05, show.legend = FALSE) +
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 0.856), color = "#d62728", size = 0.05, show.legend = FALSE) +
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 0.966), color = "#ff7f0e", size = 0.05, show.legend = FALSE) +
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 1.21), color = "#1f77b4", size = 0.05, show.legend = FALSE) +
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 1.48), color = "#9467bd", size = 0.05, show.legend = FALSE) +
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 1.80), color = "#e377c2", size = 0.05, show.legend = FALSE)
