...
Harp_seal_MSE_simulation_function_2J3K_sensitivity <- function(prop_sensitivity, region, data_simulation, title){
  ...
  gg <- ggplot(data_assessment, aes(x = Year, y = Biomass_T_area_rescale)) +
    ...
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 1.00), color = "blue", size = 0.05, show.legend = FALSE) +
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 0.958), color = "green", size = 0.05, show.legend = FALSE) +
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 0.971), color = "red", size = 0.05, show.legend = FALSE) +
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 0.980), color = "orange", size = 0.05, show.legend = FALSE) +
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 1.12), color = "blue", size = 0.05, show.legend = FALSE) +
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 1.28), color = "purple", size = 0.05, show.legend = FALSE) +
    geom_segment(aes(x = 2020, y = 1, xend = 2035, yend = 1.48), color = "pink", size = 0.05, show.legend = FALSE) 
